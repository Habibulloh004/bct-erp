// src/pages/products/AddProductCategory.jsx
...
export default function AddProduct() {
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      // Перенаправление на страницу редактирования или список товаров
  ...
  const handleFiles = async (files) => {
    ...
    try {
      ...
      if (validUrls.length > 0) {
        ...
        alert(`Загружено ${validUrls.length} из ${list.length} файлов`);
      } else {
  ...
  return (
    <div className="px-4 md:px-8 py-6">
      ...
      <div className="mb-4 text-sm text-muted-foreground">
        Товары <span className="mx-2">/</span> Добавить товар
      </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-semibold">Добавить товар</h1>
            <p className="text-muted-foreground mt-1">Создать новый товар на нескольких языках</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* ПРАВАЯ ЧАСТЬ - Изображения и превью */}
            ...
            <CardContent className="space-y-4">
              ...
              {images.length === 0 && (
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Добавьте фотографии товара</p>
                  <p className="text-xs mt-1">Первое изображение станет основным</p>
                </div>
              )}
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-3 p-3 rounded-xl border bg-muted/30">
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium">Новый товар</div>
                  <div className="text-xs text-muted-foreground">
                    {submitting ? 'Создается...' : 'Готов к созданию'}
                  </div>
                </div>
              </div>
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                ...
                <p>• Добавьте хотя бы одно изображение</p>
                <p>• Проверьте данные перед созданием</p>
              </div>
            </CardContent>
          </Card>
        </div>
